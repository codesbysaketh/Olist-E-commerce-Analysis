/*******************************************************************************************
* SECTION 1: Order Volume by Year
*******************************************************************************************/
...
/*******************************************************************************************
* SECTION 4: Sales by Product
*******************************************************************************************/

-- Gives order_id, corresponding product_id and product_category_name
...
/*******************************************************************************************
* SECTION 5: Delivery Efficiency
*******************************************************************************************/

-- Average difference between estimated delivery time and actual delivery time
SELECT ROUND(AVG(DATEDIFF(order_delivered_customer_date, order_estimated_delivery_date)), 1) AS Delivery_efficiency
FROM orders;

/* A negative value indicates that orders are delivered earlier than the expected delivery date */



/*******************************************************************************************
* SECTION 6: Average Delivery Time
*******************************************************************************************/

-- Average delivery time by region (overall)
...
-- Average delivery time by region (by city)
